...
namespace Display
{
	...
	const uint8_t palette_shades[16] =
	{
		0x00, 0x11, 0x21, 0x33,
		0x44, 0x56, 0x66, 0x77,
		0x89, 0x99, 0xAA, 0xBC,
	...
	private:
		...
		// Given an arbritary shade, gives the closest indexes in the palette to that shade, if there is an exact match both pair elements will be the same
