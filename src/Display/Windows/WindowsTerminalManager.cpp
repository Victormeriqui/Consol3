...
namespace Display
{
	namespace Windows
	{
		WindowsTerminalManager::WindowsTerminalManager(
			short width, short height, std::wstring font_name, short font_width, short font_height, const uint32_t palette[]) :
			width(width),
			height(height)
		{
		...
		void WindowsTerminalManager::SetConsoleScreenBufferInfo(
