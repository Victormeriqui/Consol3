...
namespace Engine
{
	namespace Rendering
	{
		namespace Shaders
		{
			...
			void ShadedTextureShader::FragmentShader(HSVColor& out_color, const Triangle& triangle, float barcoord0, float barcoord1, float barcoord2)
			{
				...
				out_color = HSVColor(texel_hsv.hue, texel_hsv.saturation, texel_hsv.value * final_lighting);
			}
		}
	}
}