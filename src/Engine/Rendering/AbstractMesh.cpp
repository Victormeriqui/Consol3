...
namespace Engine
{
    namespace Rendering
    {
        ...
        AbstractMesh::AbstractMesh() : color(RGBColor(255, 255, 255)), transform(Transform()), position(Vector3()), rotation(Angle()), scale(Vector3(1.0f, 1.0f, 1.0f)), material_properties(MaterialProperties())
        {
        }
