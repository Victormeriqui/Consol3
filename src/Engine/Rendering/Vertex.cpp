...
namespace Engine
{
    namespace Rendering
    {
        ...
        {
            float bitang_x_new = normal_mat.values[0][0] * bitangent.x + normal_mat.values[0][1] * bitangent.y + normal_mat.values[0][2] * bitangent.z;
            float bitang_y_new = normal_mat.values[1][0] * bitangent.x + normal_mat.values[1][1] * bitangent.y + normal_mat.values[1][2] * bitangent.z;
            float bitang_z_new = normal_mat.values[2][0] * bitangent.x + normal_mat.values[2][1] * bitangent.y + normal_mat.values[2][2] * bitangent.z;
            // float bitang_w_new =
