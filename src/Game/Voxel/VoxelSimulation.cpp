...
namespace Game
{
    namespace Voxel
    {
        ...
        Vector3I VoxelSimulation::GetSwapVoxelCoord(const Vector3I& from_coord, const Vector3& velocity)
        {
            Ray vel_ray = Ray(Vector3(from_coord), velocity);

            MarchResult march_res = vel_ray.MarchUntilHit(*voxel_grid, 1000, velocity.GetLength());
